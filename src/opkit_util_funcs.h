...
#ifndef OPKIT_UTIL_FUNCS_H
#define OPKIT_UTIL_FUNCS_H
...
void zend_accel_move_user_constants(HashTable *str, uint32_t count, zend_persistent_script *script);
