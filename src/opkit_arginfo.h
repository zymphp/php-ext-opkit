...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_opkit_compile_file, 0, 2, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, base_path, IS_STRING, 1, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_opkit_globals_mark, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_opkit_globals_cleanup, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
